...
def parse_chrX(_info, i):
    json_doc = {
        "ac": {
            ...
            "ac_sas_female": _info['AC_SAS_Female'],
            "ac_sas_male": _info['AC_SAS_Male']
        },
        "af": {
            "af": _info['AF'][i],
            "af_afr": _info['AF_AFR'][i],
            ...
            "af_sas_female": _info['AF_SAS_Female'],
            "af_sas_male": _info['AF_SAS_Male']
        },
        "an": {
            "an": _info['AN'],
            "an_afr": _info['AN_AFR'],
            ...
            "an_sas_female": _info['AN_SAS_Female'],
            "an_sas_male": _info['AN_SAS_Male']
        },
        "gc": {
            "gc": _info['GC'],
            ...
            "gc_sas_female": _info['GC_SAS_Female'],
            "gc_sas_male": _info['GC_SAS_Male']
        },
        "hemi": {
            "hemi": _info['Hemi'],
...
def _map_line_to_json(item):
    ...
    for i, alt in enumerate(item.ALT):
        ...
        one_snp_json['gnomad_exome'].update(allele_info)
