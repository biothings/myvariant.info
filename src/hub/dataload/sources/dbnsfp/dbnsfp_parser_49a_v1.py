...
COLUMNS = [
    ...
    Column("PHACTboost_score", dest="phactboost.score", transform=split_float),  # new in 4.8.a
    Column("PHACTboost_rankscore", dest="phactboost.rankscore", transform=split_float),  # new in 4.8.a
    Column("MutFormer_score", dest="mutformer.score", transform=split_float),  # new in 4.8.a
    Column("MutFormer_rankscore", dest="mutformer.rankscore", transform=split_float),  # new in 4.8.a
    Column("MutScore_score", dest="mutscore.score", transform=split_float),  # new in 4.9.a
    Column("MutScore_rankscore", dest="mutscore.rankscore", transform=split_float),  # new in 4.9.a
