...
COLUMNS = [
    ...
    Column("EVE_Class25_pred", dest="eve.class25_pred", transform=split_str_drop_na),  # new in 4.5.a
    Column("EVE_Class30_pred", dest="eve.class30_pred", transform=split_str_drop_na),  # new in 4.5.a
    Column("EVE_Class40_pred", dest="eve.class40_pred", transform=split_str_drop_na),  # new in 4.5.a
    Column("EVE_Class50_pred", dest="eve.class50_pred", transform=split_str_drop_na),  # new in 4.5.a
    Column("EVE_Class60_pred", dest="eve.class60_pred", transform=split_str_drop_na),  # new in 4.5.a
    Column("EVE_Class70_pred", dest="eve.class70_pred", transform=split_str_drop_na),  # new in 4.5.a
    ...
    Column("PHACTboost_score", dest="phactboost.score", transform=split_str_drop_na),  # new in 4.8.a
    Column("PHACTboost_rankscore", dest="phactboost.rankscore", transform=split_str_drop_na),  # new in 4.8.a
    Column("MutFormer_score", dest="mutformer.score", transform=split_str_drop_na),  # new in 4.8.a
    Column("MutFormer_rankscore", dest="mutformer.rankscore", transform=split_str_drop_na),  # new in 4.8.a
    Column("MutScore_score", dest="mutscore.score", transform=split_str_drop_na),  # new in 4.9.a
    Column("MutScore_rankscore", dest="mutscore.rankscore", transform=split_str_drop_na),  # new in 4.9.a
    ...
    Column("GERP_91_mammals", dest="gerp.91_mammals.score", transform=split_float_drop_na),  # new in 4.8.a
    Column("GERP_91_mammals_rankscore", dest="gerp.91_mammals.rankscore", transform=split_float_drop_na),  # new in 4.8.a
